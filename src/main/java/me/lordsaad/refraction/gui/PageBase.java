...
import static me.lordsaad.refraction.gui.GuiContentPage.hoverTextures;
import static me.lordsaad.refraction.gui.GuiContentPage.regularTextures;
...
public class PageBase extends GuiScreen {
    ...
    public void enableNavBar(boolean enable) {
        ...
        if (enable) {
            ...
            ResourceLocation back = new ResourceLocation(Refraction.MODID, "textures/gui/navbaricons/left_arrow.png");
            ResourceLocation back_hover = new ResourceLocation(Refraction.MODID, "textures/gui/navbaricons/hover_left_arrow.png");
            ResourceLocation next = new ResourceLocation(Refraction.MODID, "textures/gui/navbaricons/right_arrow.png");
            ResourceLocation next_hover = new ResourceLocation(Refraction.MODID, "textures/gui/navbaricons/hover_right_arrow.png");
            ResourceLocation toIndex = new ResourceLocation(Refraction.MODID, "textures/gui/navbaricons/to_index.png");
            ResourceLocation toIndex_hover = new ResourceLocation(Refraction.MODID, "textures/gui/navbaricons/hover_to_index.png");
